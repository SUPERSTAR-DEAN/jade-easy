...
AVendeur -> PAcheteur: 80
&AVendeur -> AAcheteur--: 80
AAcheteur ->o AVendeur++: 接受 80
AAcheteur -- > PAcheteur: 接受 80
AVendeur -> AAcheteur--: 确认 80 成交（对 AAcheteur）
AVendeur -- > PAcheteur: 确认 80 成交（对 AAcheteur）
...
这是 [protocols/negociation/](../../protocols/negociation/) 的"作业版"。
建议先跑通 `Main.java`，再看问题 1/2/3/4 如何逐步升级。
